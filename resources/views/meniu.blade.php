    ...
    <body class="antialiased">
        ...
        <div class="container">
            <div class="row p-4">
                ...
                <h4 class="text-secondary">Maisto Užsakymo Aplikacija</h4>
                </div>
                <div class="float-end">
                @if (Route::has('login'))
                    @auth
            ...
            <div class="container-fluid">
                <img src="{{asset('nuotraukos/istaigos/' . $istaiga->nuotrauka)}}" height="400px" width="100%" style="object-fit:cover;" alt="istaigos_nuotrauka">
            </div>
            @endforeach
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="http://localhost/maisto-aplikacija/public/">Pagrindinis</a></li>
                <li class="breadcrumb-item active" aria-current="page">Meniu</li>
            </ol>
            </nav>
            </div>    
            ...
            @foreach($ist as $istaiga)
            <div class="col-12">
            <h2 class="text-secondary">{{$istaiga->pavadinimas}} - Meniu</h2>
            </div>
            @endforeach
            ...
            <div class="card-body">
                ...
                <a href="{{ url('/meniu/' . $meniu->id) }}" class="btn btn-primary">Peržiūrėti patiekalus</a>
            </div>
            </div>
            </div>
            @endforeach
